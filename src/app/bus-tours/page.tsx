...
export default function BusToursPage() {
  ...
  const { containerRef, widgetRef, showFallback } = useViatorWidget("W-b22b5a1c-f1f0-4250-a286-b83572c5e664");
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-12 bg-gradient-to-b from-gray-50 to-white">
        <Container>
          <SectionHeader
            title="Bus Tours"
            subtitle="Explore Aruba comfortably on guided bus tours"
            center
          />
        </Container>
      </section>
          ...
          {showFallback ? (
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Browse and book bus tours directly through our partner platform
              </p>
              <a
        ...
        <Container>
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Explore available bus tours through our partner widget
            </p>
          </motion.div>
        </Container>
      </section>
