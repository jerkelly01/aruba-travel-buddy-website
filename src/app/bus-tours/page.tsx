          ...
          {loading ? (
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                {query ? 'Try adjusting your search criteria' : 'No bus tours available at the moment'}
              </p>
              {query && (
                <button
                  onClick={() => setQuery('')}
                ...
                return (
                  ...
                  >
                    <div className="card overflow-hidden h-full group flex flex-col">
                      <Link href={`/transportation/${tour.id}?from=bus`} className="flex flex-col flex-1 min-h-0">
