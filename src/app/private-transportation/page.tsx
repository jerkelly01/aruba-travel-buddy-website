...
export default function PrivateTransportationPage() {
  ...
  const { containerRef, widgetRef, showFallback } = useViatorWidget("W-4f182977-3126-4965-aeb4-7f38f620a29c");
      ...
      <section className="relative py-12 bg-gradient-to-b from-gray-50 to-white">
        <Container>
          <SectionHeader
            ...
            subtitle="Travel in comfort with private transportation services"
            center
          />
        </Container>
      </section>
          ...
          {showFallback ? (
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Browse and book private transportation directly through our partner platform
              </p>
              <a
        ...
        <Container>
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Explore available private transportation through our partner widget
            </p>
          </motion.div>
        </Container>
      </section>
