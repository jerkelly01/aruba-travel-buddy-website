        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-[var(--brand-aruba)]/10 to-[var(--brand-aruba-light)]/10 rounded-2xl p-8 shadow-lg border-2 border-[var(--brand-aruba)]/20 mb-8"
            >
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-gradient-to-r from-[var(--brand-amber)]/20 to-[var(--brand-sun)]/20 rounded-xl p-6 border-2 border-[var(--brand-amber)]/30"
              >
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-gradient-to-r from-[var(--brand-aruba)] to-[var(--brand-aruba-light)] rounded-xl p-8 text-white text-center"
              >
