...
const downloadOptions: {
  ...
  size: string;
}[] = [
    {
      ...
      href: 'https://apps.apple.com/us/app/aruba-travel-buddy/id6756806091',
            ...
            {downloadOptions.map((option, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-white border-2 border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                  {/* Gradient Accent */}
                  <div className={`absolute top-0 left-0 right-0 h-2 bg-gradient-to-r ${option.id === 'ios'
                  ...
                  <div className="p-10">
                    ...
                    <div className="flex items-start gap-6 mb-8">
                      <div className="flex-shrink-0 relative">
                        <div className="w-20 h-20 bg-white border border-gray-100 rounded-3xl flex items-center justify-center overflow-hidden shadow-2xl transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
                          <Image
                            src="/logo.png"
                            alt="App icon"
                            width={56}
                    ...
                    <a
                      ...
                      className={`group/btn w-full inline-flex items-center justify-between gap-4 px-8 py-5 rounded-2xl font-bold transition-all duration-300 hover:scale-[1.02] shadow-xl hover:shadow-2xl ${option.id === 'ios'
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-stretch max-w-2xl mx-auto">
              {downloadOptions.map((option, index) => (
                <motion.a
                  ...
                  className={`group/cta flex-1 inline-flex items-center justify-center gap-4 px-8 py-5 rounded-2xl font-bold transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-3xl ${option.id === 'ios'
